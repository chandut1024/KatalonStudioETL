...
WebUI.setText(findTestObject('Page_IMIcampaign/DataStoreName'), findTestData('DataStoreInfo').getValue(1, 2))

WebUI.setText(findTestObject('Page_IMIcampaign/ETLSchedule'), 'Every 60 Minutes')

WebUI.setText(findTestObject('Page_IMIcampaign/DataStoreLocation'), findTestData('DataStoreInfo').getValue(2, 2))

WebUI.click(findTestObject('Page_IMIcampaign/BrowseSampleFileAccordion'))

WebUI.uploadFile(findTestObject('Page_IMIcampaign/UploadComputerFile'), findTestData('DataStoreInfo').getValue(3, 2))
